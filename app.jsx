	...
	render: function() {
		...
		return (
			<div className="bellWrapper" onClick={this.onRowClick}>
				...
				<div className={'rowDate' + (this.props.index === 4 ? ' mainRowDate' : '')}>{this.rowDate()}</div>
				{
...
var BellPlayer = React.createClass({
	...
	dateChanged: function() {
		var dayCount = this.daysSinceStart(new Date);
	...
	render: function() {
		...
		return (
			<div>
                <h1>tenthousandyears</h1>
                <p>A unique chime every day for ten thousand years.</p>
				<div id="bellGrid">
